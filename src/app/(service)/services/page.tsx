...
const Services = () => {
  ...
  return (
    <div className={`min-h-screen bg-white ${raleway.className}`}>
      ...
      {/* Services Intro */}
      <section className="min-h-screen py-60 bg-gradient-to-r from-red-600/10 to-rose-600/10 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1
              className={`text-5xl md:text-6xl font-bold mb-8 text-black ${playfairDisplay.className}`}
            >
              Our{" "}
            ...
            <div className="p-8 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-2xl mb-12">
              <p
                className={`text-xl text-gray-400 leading-relaxed ${playfairDisplay.className}`}
              >
