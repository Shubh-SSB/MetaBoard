    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
                  ...
                  <div className="px-6 pb-6 pt-0 border-t border-gray-100">
                    <div className="glass-panel p-6 rounded-xl bg-gray-50">
                      ...
                      <div className="flex gap-4">
                        <div className="bg-primary hover:bg-red-700 text-white px-6 py-2 rounded-full font-semibold transition-all duration-300 ripple-effect inline-block text-center">
                          Upcoming
                        </div>
                        <a
                          href="#contact-form"
          ...
          <div
            id="contact-form"
            className="max-w-2xl mx-auto mt-20 p-8 glass-panel rounded-2xl bg-gray-50"
          >
            ...
            <form className="space-y-4">
              ...
              <select
                title="service"
                className="w-full glass-input p-3 rounded-lg border border-gray-200 bg-white/80 backdrop-blur-sm focus:border-red-600 focus:outline-none transition-colors"
              >
